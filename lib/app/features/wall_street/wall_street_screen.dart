...
class WallStreetArticlesScreen extends StatelessWidget {
  WallStreetArticlesScreen({super.key});
  final _controller = Get.find<ArticleWallStreetController>();

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ArticleWallStreetController>(
        id: 'init_refresh',
        init: ArticleWallStreetController(),
        builder: (_) {
          return Scaffold(
            body: Center(
                        ...
                        builder: (context, snapshot) {
                          if (_controller.isNotConnected) {
                            ...
                            return RefreshIndicator(
                                child: GetBuilder<ArticleWallStreetController>(
                                    id: 'articles',
                                    init: ArticleWallStreetController(),
                                    builder: (_) {
