...
class TeslaArticlesScreen extends StatelessWidget {
  TeslaArticlesScreen({super.key});
  final _controller = Get.find<ArticleTesalController>();

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ArticleTesalController>(
        id: 'init_refresh',
        init: ArticleTesalController(),
        builder: (_) {
          return Scaffold(
            body: Center(
                        ...
                        builder: (context, snapshot) {
                          if (_controller.isNotConnected) {
                            ...
                            return RefreshIndicator(
                                child: GetBuilder<ArticleTesalController>(
                                    id: 'articles',
                                    init: ArticleTesalController(),
                                    builder: (_) {
